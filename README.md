...
Results
SplitIoUPrecisionRecallF1 ScoreValidation (n=334)0.5170.5800.8240.681Test (n=77)0.1710.1990.5560.293
...
Evaluation
bashpython eval.py --data_path data/test --weights checkpoints/best_model.pth
...
bashpython eval.py --data_path data/val --weights checkpoints/best_model.pth
...
Buslaev et al. (2020). Albumentations: Fast and Flexible Image Augmentations. Information.
